...
export default function ProjectDashboard({ params }: { params: { id: string } }) {
  ...
  const { data: project, isLoading: isProjectLoading } = useGetProject(projectId, { query: { enabled: !!projectId } });
  ...
  if (isProjectLoading) return <AppLayout><Skeleton className="h-[600px] w-full" /></AppLayout>;
                ...
                <div className="bg-muted/30 p-4 rounded-md flex justify-between items-center">
                  <div>
                    ...
                    <div className="text-3xl font-bold">
                      {calculation ? calculation.grandTotal.toLocaleString('en-US', { maximumFractionDigits: 0 }) : "..."}
